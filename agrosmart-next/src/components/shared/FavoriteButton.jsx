...
// Рӯйхати нигоҳдоштаҳо як маротиба барои тамоми саҳифа бор мешавад ва
// ҳамаи тугмаҳо ҳамонро мебинанд — вагарна ҳар корт дархости худашро мефиристод.
const keys = new Set();
...
// Тугмаи "дил" — дар кортҳои бозор, замин ва дорувори
export default function FavoriteButton({ itemType, itemId }) {
  ...
  async function toggle(e) {
    e.stopPropagation();
    // Аввал дар экран иваз мекунем, то тугма фавран ҷавоб диҳад
