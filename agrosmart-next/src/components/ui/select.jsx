...
// Селекти стандартии shadcn/ui — барои иваз кардани ҳамаи <select>-ҳои сайт
//
// МУҲИМ: Модалҳои сайт тегҳои <dialog> бо showModal() мебошанд. Онҳо дар
// "top layer"-и браузер ҷойгиранд, аз ин рӯ рӯйхати селект, ки ба document.body
// портал мешуд, дар ЗЕРИ модал мемонд ва клик намешуд. Барои ҳамин мо
// контейнери порталро аз худи <dialog> мегирем.
...
export function SelectTrigger({ className, children, ...props }) {
  ...
  // Ҳангоми монтаж муайян мекунем, ки селект дар дохили кадом <dialog> аст
  ...
  return (
    <SelectPrimitive.Portal container={ctx?.container ?? undefined}>
      <SelectPrimitive.Content
        position={position}
        className={cn(
          // z-index бояд аз навбарҳо (z-index: 1000) ва оверлейҳо баландтар бошад
