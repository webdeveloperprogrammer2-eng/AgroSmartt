...
// Калиди ягонаи як мол: "mahsulot:12"
function keyOf(itemType, itemId) {
  return `${itemType}:${itemId}`;
}

// Нигоҳдоштаҳои корбари ҷорӣ. Рӯйхат як маротиба бор мешавад,
// баъд тугмаи "дил" фавран дар браузер иваз мешавад ва сервер аз паси он меравад.
export function useFavorites(userId) {
  ...
  const toggle = useCallback(
    async (itemType, itemId, item) => {
      ...
      // Аввал дар экран иваз мекунем, то тугма дарҳол ҷавоб диҳад
      setItems((prev) =>
        exists
