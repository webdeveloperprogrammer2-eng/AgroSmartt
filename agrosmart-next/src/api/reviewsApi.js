...
// Дар API endpoint-и алоҳидаи /reviews вуҷуд надорад, барои ҳамин отзивҳо
// дар худи сабти корбар (майдони `reviews`) нигоҳ дошта мешаванд.

// Миёнаи баҳо — 0 агар ҳанӯз отзив набошад
...
export const reviewsApi = {
  ...
  // Як корбар ба як ронанда танҳо ЯК отзив монда метавонад —
  // агар боз нависад, отзиви кӯҳнааш иваз мешавад, на такрор.
