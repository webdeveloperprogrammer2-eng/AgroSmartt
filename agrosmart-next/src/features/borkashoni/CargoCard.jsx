...
// Як дархости боркашонӣ: аз кадом шаҳр то кадом шаҳр, чанд бор ва чанд пул
export default function CargoCard({ request, isOwner, isDriver, onAccept, onChat, onDelete }) {
  ...
  return (
    <article className={`cargo-card ${accepted ? "is-accepted" : ""}`}>
      ...
      {/* Тамос бо ронанда танҳо ба соҳиби дархост лозим аст —
          ба каси дигар номи ӯ нишон дода намешавад */}
      {accepted && !isOwner && (
      ...
      {/* Қабул ва чат танҳо барои ронандагони сабтшуда — харидори оддӣ
          бор кашонда наметавонад, бинобар ин ба ӯ ин тугмаҳо намебароянд */}
