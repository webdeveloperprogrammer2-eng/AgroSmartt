...
// Кабинети ронанда — тамоман дигар аз кабинети деҳқон/харидор:
// ин ҷо на маҳсулот ва замин, балки бор, баҳо ва отзивҳо муҳиманд.
    ...
    <>
      ...
      <main className="dcab">
        <section className="dcab-hero">
          ...
          <Link href={`/ronandagon/${user.id}`} className="dcab-hero-link">
            {t("driverPublicPage")}
          </Link>
        </section>
        ...
        {/* Худи дархостҳо дар саҳифаи алоҳидаи "Боркашонӣ" мемонанд —
            ин ҷо танҳо роҳи кӯтоҳ ба он аст */}
        <Link href="/borkashoni" className="dcab-cta">
