...
// Панели воридшавии Admin / SuperAdmin.
// Майдони аввал ҳамон рақами телефон аст, ки дар /users нигоҳ дошта мешавад —
// пештар ӯро "Код" меномид ва корбарро ба иштибоҳ меандохт.
export default function AdminLoginPanel({ onSubmit }) {
  ...
  return (
    ...
    >
      ...
      {/* Ду тугмаи возеҳ ба ҷои switch — фавран маълум аст, кадомаш интихоб шудааст */}
