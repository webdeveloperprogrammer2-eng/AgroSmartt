...
// Нимаи чапи саҳифаи Auth — намуди "табиат" бо градиенти сабз
export default function AuthNaturePanel() {
  const { t } = useTranslation();

  return (
    <div className="relative hidden md:flex md:w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-emerald-800 via-green-700 to-lime-600 p-10 text-white">
      {/* Доираҳои ороишӣ */}
      ...
      <div className="pointer-events-none absolute left-1/3 top-1/2 h-40 w-40 rounded-full bg-lime-300/20 blur-2xl" />
      ...
      <div className="relative z-10 max-w-sm animate-fade-in-up">
        <h2 className="mb-4 font-serif text-4xl font-bold leading-tight">{t("authPanelHeading")}</h2>
