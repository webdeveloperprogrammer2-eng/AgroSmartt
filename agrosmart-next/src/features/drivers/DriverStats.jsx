...
// Ҳисоби пешрафт аз рӯи отзивҳо: чанд бор 5, чанд бор 4 ва ғайра
...
// Графикҳои пешрафти ронанда: тақсимоти баҳоҳо ва ду ченаки фоизӣ.
// Ҳар график ЯК ченак дорад, бинобар ин ЯК ранг мегирад —
// рангинкамон дар ин ҷо маъно надорад ва танҳо чашмро мебандад.
            ...
            {STARS.map((star) => {
              ...
              return (
                <div key={star} className="dbar-row" title={`${star}★ — ${count}`}>
                  <span className="dbar-star">{star}★</span>
