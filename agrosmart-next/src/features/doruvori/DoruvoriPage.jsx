...
// Саҳифаи бозори дорувори — грид, ҷустуҷӯ, филтр, сабад ва фармоиш
export default function DoruvoriPage() {
  ...
  function handleBuy(item) {
    ...
    // Бе сабти ном фармоиш додан мумкин нест
    if (!user) {
  ...
  // Ба ҷои боти Telegram: ба соҳиби ҳар дору хабарномаи алоҳида меравад
