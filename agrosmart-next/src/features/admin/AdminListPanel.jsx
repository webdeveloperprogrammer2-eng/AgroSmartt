...
// Рӯйхати идоракунии бахши ҷорӣ (замин / маҳсулот / дорувори / дархостҳо).
// Компонент якто аст барои ҳамаи бахшҳо — сарлавҳа, матни холӣ ва сатрҳо
// аз `section` (нигаред adminSections.js) мегиранд, бинобар ин ҳангоми
// гузариши таб ҷойгиршавии саҳифа тағйир намеёбад.
    ...
    <Card>
      <CardContent className="p-5">
        ...
        <div className="flex flex-col divide-y divide-border">
          ...
          {list.map((item) => {
            // Сатрҳои холӣ партофта мешаванд, то "· ·"-и бесоҳиб намонад
