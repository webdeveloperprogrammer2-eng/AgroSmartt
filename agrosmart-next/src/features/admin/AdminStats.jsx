...
// Статистикаи кӯтоҳ дар болои панели admin.
// Ҳар корт ҳамзамон тугма аст — рақамро нишон медиҳад ва бахши поёнро иваз мекунад.
// Ҳолати фаъол бо `ring` ва `bg` дода мешавад, на бо `border` — соя андозаи
// кортро тағйир намедиҳад, бинобар ин ҳангоми гузариш ҷадвал намеҷунбад.
