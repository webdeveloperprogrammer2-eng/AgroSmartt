...
// Формаи умумии иловаи/таҳрири сабт барои ҳамаи бахшҳои admin.
// Майдонҳо аз `section.fields` сохта мешаванд — барои ҳар бахш формаи
// ҷудогона навиштан лозим нест ва тарҳи модал ҳамеша якхела мемонад.
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-3">
          {section.fields.map((field) => {
            ...
            // Сурат аз компютери худи корбар гирифта мешавад, на аз суроға
            if (field.type === "image") {
              return (
