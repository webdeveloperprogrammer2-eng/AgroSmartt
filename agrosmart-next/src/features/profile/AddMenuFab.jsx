...
// Тугмаи "+" дар кунҷи саҳифа ва менюи хурди иловакунӣ.
// Пештар ин ҷо се корти калон буданд, ки дар телефон қариб тамоми
// экранро мегирифтанд — ҳоло ҳамон се амал дар як равзанаи ҷамъу ҷур.
export default function AddMenuFab({ onAddProduct, onAddLand, onAddMedicine }) {
  const [open, setOpen] = useState(false);
  const wrapRef = useRef(null);
  const { t } = useTranslation();

  // Клики берунӣ ва Escape менюро мепӯшанд
  useEffect(() => {
    if (!open) return;
