...
// Се формаи ҳисоб: маълумоти шахсӣ, рақами телефон, парол + несткунии ҳисоб.
// Ҳар кадом ба endpoint-и худаш меравад (ниг. Swagger: тамғаи Settings).
export default function DrawerAccountForms({ user, onUpdated, onDeleted }) {
  ...
  // Ҳар се форма як хел ҷавоб медиҳанд — паём дар як ҷои умумӣ мебарояд
