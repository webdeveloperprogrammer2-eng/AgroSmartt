...
// Логои (аватари) корбар — рост аз суратгираки дастгоҳ гирифта мешавад.
// API захираи файли алоҳида надорад, бинобар ин сурат ҳамчун data-URL
// ба /settings/profile меравад (сатри холӣ онро нест мекунад).
export default function AvatarPicker({ name, value, onChange }) {
  ...
  // Суратгирак ҳатман хомӯш карда мешавад — вагарна чароғаки камера
  // баъд аз пӯшидани панел ҳам фурӯзон мемонад
  function stopCamera() {
  ...
  async function openCamera() {
    ...
    try {
      ...
      setOpen(true);
      // Видео танҳо баъд аз он ки панел кушода шуд, дар DOM пайдо мешавад
  ...
  // Кадри ҷориро ба росткунҷаи мураббаъ мебурем, то аватар кашол нашавад
  function takePhoto() {
